                  ...
                  <div className="col-auto d-none d-lg-block">
                    <div style={{ width: '320px' }} className='py-4'>
                      ...
                      <div className='py-3'>
                        ...
                        Join the Nike Team – Where Innovation Meets Passion!
                        </div>
                      </div>
                      <div className='pb-3'>
                        <div style={{ color: '#1C2B34', fontSize: '15px', lineHeight: 1.3 }}>
                        Be part of a global movement that inspires athletes and dreamers. Explore exciting career opportunities and make an impact today!
                        </div>
                      </div>
                      <div className='pb-2'>
